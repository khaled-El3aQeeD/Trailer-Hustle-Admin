...
class SupabaseConfig {
  static const String supabaseUrl = 'https://ayfimjasvborgaaxudqq.supabase.co';
  static const String anonKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImF5ZmltamFzdmJvcmdhYXh1ZHFxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjY1Njk3MDAsImV4cCI6MjA4MjE0NTcwMH0.ftzYyV5Osydf_kwd8rrTro-5bXZ29SoNPQX2YW9_sC8';
...
class SupabaseService {
  ...
  static String _handleDatabaseError(
    ...
    if (error is PostgrestException) {
      // Keep the original message but also include code/details if present.
      ...
      return extra.isEmpty
          ? 'Failed to $operation from $table: ${error.message}'
          : 'Failed to $operation from $table: ${error.message} ($extra)';
    } else {
